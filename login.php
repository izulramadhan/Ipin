...
<body style="background: url(images/bg.jpg) no-repeat; background-size: cover;" >
    <div class="page-wrapper">
        <div class="">
            <div class="container">
                <br><br>
                <div class="login-wrap" style="margin-bottom: 30px; margin-left: 0px;">
                    <div class="login-content" style="background-color: rgba(505,505,505, 0.3);">
                        ...
                        <div class="login-form" style="margin-top: -40px;">
                            <form action="" method="post">
                                ...
                                <br>
                                <button name="btnLogin" class="au-btn au-btn--block au-btn--green m-b-20" type="submit">LOGIN</button>
                            </form>
                        </div>
                    </div>
                </div>
