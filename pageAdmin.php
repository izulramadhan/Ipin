                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            ...
                            <i class="fas fa-users"></i>Pertumbuhan</a>
                        </li>
                        <li>
                            <a href="?page=viewPerkembangan">
                            <i class="fas fa-filter"></i>Perkembangan</a>
                        </li>
                    </ul>
                </nav>
            </div>
			...
			<?php 
				...
				switch($page){
					case 'viewBarang':
						...
						break;
                    case 'viewPertumbuhan':
                        include "admin/viewPertumbuhan.php";
                        break;
                    case 'viewPerkembangan':
                        include "admin/viewPerkembangan.php";
                        break;
                    case 'addBarang':
